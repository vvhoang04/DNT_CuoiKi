...
class _VocabScreenState extends State<VocabScreen> {
  ...
  List<VocabTopic> _scrapedTopics = [];
  ...
  Future<void> _loadTopics() async {
    ...
    try {
      final topics = await _scraperService.scrapeTopics(
        'https://langmaster.edu.vn/tong-hop-3000-tu-vung-tieng-anh-thong-dung-theo-chu-de',
      );

      if (mounted) {
        setState(() {
          _scrapedTopics = topics;
          _isLoading = false;
        });
      }
    } catch (e) {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _scrapedTopics.isNotEmpty
                  ? _buildScrapedCategoriesGrid()
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            _scrapedTopics.isNotEmpty
                ? "Đã tải ${_scrapedTopics.length} chủ đề"
  ...
  Widget _buildScrapedCategoriesGrid() {
    return GridView.builder(
      physics: const NeverScrollableScrollPhysics(),
      shrinkWrap: true,
      itemCount: _scrapedTopics.length,
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: 2,
        crossAxisSpacing: 16,
        mainAxisSpacing: 16,
        childAspectRatio: 0.85, // Tăng từ 0.75 lên 0.85 để card rộng hơn
      ),
      itemBuilder: (context, index) {
        final topic = _scrapedTopics[index];
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8), // Thêm khoảng cách cố định
                // Topic Name - Flexible để tránh overflow
                Flexible(
                  child: Text(
                    topic.name,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  // TODO: Navigate to vocabulary list page
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Đang mở: ${topic.name}'),
