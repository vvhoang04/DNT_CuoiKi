...
//     try {
//       final vocabularies = await _scraperService.scrapeVocabulary(
//         widget.topic.url,
//         tableIndex: widget.topic.tableIndex,
//       );
...
//         context,
//       ).showSnackBar(SnackBar(content: Text('Không thể tải từ vựng: $e')));
//     }
//   }
...
//                                       _PartOfSpeech(
//                                         part: currentWord['partOfSpeech'] ?? '',
//                                         translation:
//                                             currentWord['partOfSpeechVi'] ?? '',
//                                         color: widget.topic.color,
//                                       ),
//                                       const SizedBox(height: 24),
//                                       _ExampleSection(
            ...
            ? Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    Text(
                      'Đang tải từ Google Sheets...', // ✅ Cập nhật text
                      style: TextStyle(
